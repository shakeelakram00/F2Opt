...
wire   [0:0] icmp_ln481_fu_103_p2;
reg    ap_block_state1_pp0_stage0_iter0;
reg   [1:0] ap_CS_iter1_fsm;
reg   [0:0] icmp_ln481_reg_212;
reg   [0:0] icmp_ln490_reg_222;
reg    ap_predicate_op39_write_state2;
reg    ap_block_state2_pp0_stage0_iter1;
reg    ap_block_state2_io;
wire    ap_CS_iter1_fsm_state2;
reg   [1:0] ap_CS_iter2_fsm;
reg   [0:0] icmp_ln481_reg_212_pp0_iter1_reg;
reg   [0:0] icmp_ln490_reg_222_pp0_iter1_reg;
...
wire   [0:0] ei_V_fu_118_p1;
reg   [0:0] ei_V_reg_216;
wire   [0:0] icmp_ln490_fu_128_p2;
reg   [10:0] p_Val2_s_fu_60;
wire   [10:0] trunc_ln_fu_177_p3;
wire    ap_loop_init;
reg   [31:0] i_fu_64;
wire   [31:0] i_1_fu_122_p2;
reg   [31:0] ap_sig_allocacmp_i_load;
reg   [9:0] t_fu_68;
wire   [9:0] t_2_fu_109_p2;
reg   [9:0] ap_sig_allocacmp_t_1;
wire   [11:0] p_Result_s_fu_152_p3;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_273)) begin
        if (((icmp_ln481_fu_103_p2 == 1'd0) & (icmp_ln490_fu_128_p2 == 1'd1))) begin
            i_fu_64 <= 32'd0;
        end else if (((icmp_ln481_fu_103_p2 == 1'd0) & (icmp_ln490_fu_128_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((icmp_ln481_fu_103_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1) & (ap_loop_init == 1'b1))) begin
        p_Val2_s_fu_60 <= 11'd0;
    end else if ((~((1'b1 == ap_block_state2_io) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter1_fsm_state2) & (icmp_ln481_reg_212 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_273)) begin
        if ((icmp_ln481_fu_103_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((icmp_ln481_fu_103_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1) & (icmp_ln481_fu_103_p2 == 1'd0))) begin
        ei_V_reg_216 <= ei_V_fu_118_p1;
        icmp_ln490_reg_222 <= icmp_ln490_fu_128_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((icmp_ln481_fu_103_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
        icmp_ln481_reg_212 <= icmp_ln481_fu_103_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b1 == ap_block_state2_io) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter1_fsm_state2))) begin
        icmp_ln481_reg_212_pp0_iter1_reg <= icmp_ln481_reg_212;
        icmp_ln490_reg_222_pp0_iter1_reg <= icmp_ln490_reg_222;
    end
end

always @ (*) begin
    if (((icmp_ln481_fu_103_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) begin
...
always @ (*) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((icmp_ln481_fu_103_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1) & (icmp_ln481_fu_103_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_iter0_fsm_state1) & (icmp_ln481_fu_103_p2 == 1'd0))) begin
...
always @ (*) begin
    case (ap_CS_iter1_fsm)
        ap_ST_iter1_fsm_state2 : begin
            if ((~((1'b1 == ap_block_state2_io) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))) & ~((icmp_ln481_fu_103_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0)) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
                ap_NS_iter1_fsm = ap_ST_iter1_fsm_state2;
            end else if ((~((1'b1 == ap_block_state2_io) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))) & ((1'b0 == ap_CS_iter0_fsm_state1) | ((1'b1 == ap_CS_iter0_fsm_state1) & (icmp_ln481_fu_103_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))))) begin
...
always @ (*) begin
    case (ap_CS_iter2_fsm)
        ap_ST_iter2_fsm_state3 : begin
            ...
            end else if ((~((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))) & (icmp_ln481_reg_212_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_iter2_fsm_state3))) begin
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((icmp_ln481_fu_103_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0));
end
...
always @ (*) begin
    ap_condition_273 = (~(((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((icmp_ln481_fu_103_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1));
end

always @ (*) begin
    ap_predicate_op39_write_state2 = ((icmp_ln490_reg_222 == 1'd1) & (icmp_ln481_reg_212 == 1'd0));
end

always @ (*) begin
    ap_predicate_op45_write_state3 = ((icmp_ln490_reg_222_pp0_iter1_reg == 1'd1) & (icmp_ln481_reg_212_pp0_iter1_reg == 1'd0));
end
...
assign ei_V_fu_118_p1 = in0_V_TDATA_int_regslice[0:0];

assign i_1_fu_122_p2 = (ap_sig_allocacmp_i_load + 32'd1);

assign icmp_ln481_fu_103_p2 = ((ap_sig_allocacmp_t_1 == 10'd756) ? 1'b1 : 1'b0);

assign icmp_ln490_fu_128_p2 = ((i_1_fu_122_p2 == 32'd12) ? 1'b1 : 1'b0);
...
assign t_2_fu_109_p2 = (ap_sig_allocacmp_t_1 + 10'd1);

assign tmp_fu_167_p4 = {{p_Val2_s_fu_60[10:1]}};
