...
(* CORE_GENERATION_INFO="StreamingDataWidthConverter_Batch_1_StreamingDataWidthConverter_Batch_1,hls_ip_2022_2_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.591000,HLS_SYN_LAT=870,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=72,HLS_SYN_LUT=191,HLS_VERSION=2022_2_2}" *)
...
wire   [0:0] icmp_ln481_fu_105_p2;
reg    ap_block_state1_pp0_stage0_iter0;
reg   [1:0] ap_CS_iter1_fsm;
reg   [0:0] icmp_ln481_reg_214;
reg   [0:0] icmp_ln490_reg_224;
reg    ap_predicate_op39_write_state2;
reg    ap_block_state2_pp0_stage0_iter1;
reg    ap_block_state2_io;
wire    ap_CS_iter1_fsm_state2;
reg   [1:0] ap_CS_iter2_fsm;
reg   [0:0] icmp_ln481_reg_214_pp0_iter1_reg;
reg   [0:0] icmp_ln490_reg_224_pp0_iter1_reg;
...
wire   [6:0] ei_V_fu_120_p1;
reg   [6:0] ei_V_reg_218;
wire   [0:0] icmp_ln490_fu_130_p2;
reg   [13:0] p_Val2_s_fu_62;
wire   [13:0] trunc_ln_fu_179_p3;
wire    ap_loop_init;
reg   [31:0] i_fu_66;
...
wire   [20:0] p_Result_s_fu_154_p3;
wire   [6:0] tmp_fu_169_p4;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_274)) begin
        if (((icmp_ln481_fu_105_p2 == 1'd0) & (icmp_ln490_fu_130_p2 == 1'd1))) begin
            i_fu_66 <= 32'd0;
        end else if (((icmp_ln481_fu_105_p2 == 1'd0) & (icmp_ln490_fu_130_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((icmp_ln481_fu_105_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1) & (ap_loop_init == 1'b1))) begin
        p_Val2_s_fu_62 <= 14'd0;
    end else if ((~((1'b1 == ap_block_state2_io) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter1_fsm_state2) & (icmp_ln481_reg_214 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_274)) begin
        if ((icmp_ln481_fu_105_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((icmp_ln481_fu_105_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1) & (icmp_ln481_fu_105_p2 == 1'd0))) begin
        ei_V_reg_218 <= ei_V_fu_120_p1;
        icmp_ln490_reg_224 <= icmp_ln490_fu_130_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((icmp_ln481_fu_105_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
        icmp_ln481_reg_214 <= icmp_ln481_fu_105_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b1 == ap_block_state2_io) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter1_fsm_state2))) begin
        icmp_ln481_reg_214_pp0_iter1_reg <= icmp_ln481_reg_214;
        icmp_ln490_reg_224_pp0_iter1_reg <= icmp_ln490_reg_224;
    end
end

always @ (*) begin
    if (((icmp_ln481_fu_105_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) begin
...
always @ (*) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((icmp_ln481_fu_105_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1) & (icmp_ln481_fu_105_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_iter0_fsm_state1) & (icmp_ln481_fu_105_p2 == 1'd0))) begin
...
always @ (*) begin
    case (ap_CS_iter1_fsm)
        ap_ST_iter1_fsm_state2 : begin
            if ((~((1'b1 == ap_block_state2_io) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))) & ~((icmp_ln481_fu_105_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0)) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
                ap_NS_iter1_fsm = ap_ST_iter1_fsm_state2;
            end else if ((~((1'b1 == ap_block_state2_io) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))) & ((1'b0 == ap_CS_iter0_fsm_state1) | ((1'b1 == ap_CS_iter0_fsm_state1) & (icmp_ln481_fu_105_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))))) begin
...
always @ (*) begin
    case (ap_CS_iter2_fsm)
        ap_ST_iter2_fsm_state3 : begin
            ...
            end else if ((~((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))) & (icmp_ln481_reg_214_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_iter2_fsm_state3))) begin
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((icmp_ln481_fu_105_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0));
end
...
always @ (*) begin
    ap_condition_274 = (~(((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((ap_predicate_op45_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op39_write_state2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((icmp_ln481_fu_105_p2 == 1'd0) & (in0_V_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1));
end

always @ (*) begin
    ap_predicate_op39_write_state2 = ((icmp_ln490_reg_224 == 1'd1) & (icmp_ln481_reg_214 == 1'd0));
end

always @ (*) begin
    ap_predicate_op45_write_state3 = ((icmp_ln490_reg_224_pp0_iter1_reg == 1'd1) & (icmp_ln481_reg_214_pp0_iter1_reg == 1'd0));
end
...
assign ei_V_fu_120_p1 = in0_V_TDATA_int_regslice[6:0];

assign i_1_fu_124_p2 = (ap_sig_allocacmp_i_load + 32'd1);

assign icmp_ln481_fu_105_p2 = ((ap_sig_allocacmp_t_1 == 10'd867) ? 1'b1 : 1'b0);

assign icmp_ln490_fu_130_p2 = ((i_1_fu_124_p2 == 32'd3) ? 1'b1 : 1'b0);
...
assign tmp_fu_169_p4 = {{p_Val2_s_fu_62[13:7]}};
