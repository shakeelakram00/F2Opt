...
module MatrixVectorActivation_0_imp_MT0NP
  ...
  wire [511:0]MatrixVectorActivation_0_wstrm_m_axis_0_TDATA;
...
module StreamingDataWidthConverter_Batch_1_imp_1TTTNBG
   (ap_clk,
    ap_rst_n,
    in0_V_tdata,
    in0_V_tready,
...
(* CORE_GENERATION_INFO = "finn_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=finn_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=22,numReposBlks=16,numNonXlnxBlks=0,numHierBlks=6,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=7,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "finn_design.hwdef" *) 
module finn_design
   (ap_clk,
    ap_rst_n,
    m_axis_0_tdata,
  ...
  StreamingDataWidthConverter_Batch_1_imp_1TTTNBG StreamingDataWidthConverter_Batch_1
       (.ap_clk(ap_clk_0_1),
        .ap_rst_n(ap_rst_n_0_1),
