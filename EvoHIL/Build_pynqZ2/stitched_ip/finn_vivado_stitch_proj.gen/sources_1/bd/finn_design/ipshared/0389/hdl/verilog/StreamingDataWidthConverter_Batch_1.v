...
wire   [2:0] ei_V_fu_120_p1;
reg   [2:0] ei_V_reg_218;
wire   [0:0] icmp_ln490_fu_130_p2;
reg   [17:0] p_Val2_s_fu_62;
wire   [17:0] trunc_ln_fu_179_p3;
wire    ap_loop_init;
reg   [31:0] i_fu_66;
...
assign ei_V_fu_120_p1 = in0_V_TDATA_int_regslice[2:0];

assign i_1_fu_124_p2 = (ap_sig_allocacmp_i_load + 32'd1);

assign icmp_ln481_fu_105_p2 = ((ap_sig_allocacmp_t_1 == 11'd2023) ? 1'b1 : 1'b0);

assign icmp_ln490_fu_130_p2 = ((i_1_fu_124_p2 == 32'd7) ? 1'b1 : 1'b0);
...
assign tmp_fu_169_p4 = {{p_Val2_s_fu_62[17:3]}};
